...
if(isset($_POST['close_account'])) {
	$close_query = mysqli_query($con, "UPDATE users SET IsClosed='yes' WHERE UserName='$userLoggedIn'");
	session_destroy();
...
<div class="main_column column">
	...
	You can reopen your account at any time by simply logging in.<br><br>
